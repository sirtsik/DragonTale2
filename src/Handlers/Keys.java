...
public class Keys {
    ...
    public static int GLIDE = 4;
    public static int SCRATCH = 5;
    public static int FIREBALL = 6;
    public static int JUMP = 7;
    ...
    public static void keySet(int i, boolean b) {
        ...
        else if(i == KeyEvent.VK_UP) keyState[GLIDE] = b;
        else if(i == KeyEvent.VK_RIGHT) keyState[SCRATCH] = b;
        else if(i == KeyEvent.VK_DOWN) keyState[FIREBALL] = b;
